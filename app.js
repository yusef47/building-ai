...
// ⚠️ CHANGE THIS to your Hugging Face Space URL after deployment
const API_URL = "https://yusef75-building-detection.hf.space";
...
async function detectBuildings() {
    ...
    try {
        ...
        setStatus("done", `✅ تم اكتشاف ${data.stats.buildings_detected} مبنى!`);
